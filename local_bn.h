...
// UDI_BN_SQR *UDI_BN_new(void);
// void UDI_BN_free(UDI_BN_SQR *a);
// void UDI_BN_from_bn(UDI_BN_SQR *to, const BIGNUM *from, const BIGNUM *N);
// void UDI_BN_to_bn(BIGNUM *to, const UDI_BN_SQR *from, const BIGNUM *N);
...
int BN_mod_exp_simple(BIGNUM *r, const BIGNUM *a, const BIGNUM *p,
                      const BIGNUM *m, BN_CTX *ctx);
int BN_mod_exp_udi(BIGNUM *r, const BIGNUM *a, const BIGNUM *p,
               const BIGNUM *m, BN_CTX *ctx);
